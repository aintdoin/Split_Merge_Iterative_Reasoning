...
export SYSTEM_PROMPT_TYPE=idk_not_aware 
export CONFIDENCE_THRESHOLD=${CONFIDENCE_THRESHOLD:--15.0}

OUTPUT_FILE=inference/inference_results/$MODEL_NAME/${DATASET}_confidence.jsonl
...
export IDK=true
python inference/inference_with_confidence.py \
